...
const DatasetCenter = lazy(() => import("./DatasetCenter").then((module) => ({ default: module.DatasetCenter })));
...
const TeacherCenter = lazy(() => import("./TeacherCenter").then((module) => ({ default: module.TeacherCenter })));
const SchoolAdminCenter = lazy(() => import("./SchoolAdminCenter").then((module) => ({ default: module.SchoolAdminCenter })));
const CdKeyManagement = lazy(() => import("./CdKeyManagement").then((module) => ({ default: module.CdKeyManagement })));
